...
#pragma region Windows Form Designer generated code
...

		{
			...
			this->vivod = (gcnew System::Windows::Forms::TextBox());
			...
			this->vivod->CausesValidation = false;
			this->vivod->ForeColor = System::Drawing::SystemColors::Desktop;
			this->vivod->HideSelection = false;
			this->vivod->ImeMode = System::Windows::Forms::ImeMode::Off;
			this->vivod->Location = System::Drawing::Point(150, 150);
			this->vivod->Name = L"vivod";
			this->vivod->ReadOnly = true;
			this->vivod->Size = System::Drawing::Size(200, 20);
			this->vivod->TabIndex = 0;
			this->vivod->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			// 
			// radioButton1
			// 
